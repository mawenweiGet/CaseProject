namespace Modbus.Message
{
    ...
    public class WriteSingleRegisterRequestResponse : AbstractModbusMessageWithData<RegisterCollection>, IModbusRequest
    {
        ...
        public WriteSingleRegisterRequestResponse(byte slaveAddress, ushort startAddress, short registerValue)
        ...
        protected override void InitializeUnique(byte[] frame)
        {
            ...
            Data = new RegisterCollection((short) IPAddress.NetworkToHostOrder(BitConverter.ToInt16(frame, 4)));
        }
    }
}
