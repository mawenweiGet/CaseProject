namespace Modbus.Device
{
    ...
    public class ModbusIpMaster : ModbusMaster
    {
        ...
        /// <param name="numberOfPoints">Number of holding registers to read.</param>
        /// <returns>A task that represents the asynchronous read operation</returns>
        public Task<short[]> ReadHoldingRegistersAsync(ushort startAddress, ushort numberOfPoints)
        {
        ...
        /// <param name="numberOfPoints">Number of holding registers to read.</param>
        /// <returns>A task that represents the asynchronous read operation</returns>
        public Task<short[]> ReadInputRegistersAsync(ushort startAddress, ushort numberOfPoints)
        {
        ...
        /// <param name="value">Value to write.</param>
        /// <returns>A task that represents the asynchronous write operation</returns>
        public Task WriteSingleRegisterAsync(ushort registerAddress, short value)
        {
        ...
        /// <param name="data">Values to write.</param>
        /// <returns>A task that represents the asynchronous write operation</returns>
        public Task WriteMultipleRegistersAsync(ushort startAddress, short[] data)
        {
        ...
        public short[] ReadWriteMultipleRegisters(ushort startReadAddress, ushort numberOfPointsToRead,
        ...
        public Task<short[]> ReadWriteMultipleRegistersAsync(ushort startReadAddress, ushort numberOfPointsToRead,
            ushort startWriteAddress, short[] writeData)
        {
