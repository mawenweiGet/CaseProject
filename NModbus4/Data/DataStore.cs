namespace Modbus.Data
{
    ...
    public class DataStore
    {
        ...
        public DataStore()
        {
            ...
            HoldingRegisters = new ModbusDataCollection<short> {ModbusDataType = ModbusDataType.HoldingRegister};
            InputRegisters = new ModbusDataCollection<short> {ModbusDataType = ModbusDataType.InputRegister};
        }

        internal DataStore(IList<bool> coilDiscretes, IList<bool> inputDiscretes, IList<short> holdingRegisters, IList<short> inputRegisters)
        {
            ...
            HoldingRegisters = new ModbusDataCollection<short>(holdingRegisters) { ModbusDataType = ModbusDataType.HoldingRegister };
            InputRegisters = new ModbusDataCollection<short>(inputRegisters) { ModbusDataType = ModbusDataType.InputRegister };
        }
        ...
        /// </summary>
        public ModbusDataCollection<short> HoldingRegisters { get; private set; }

        /// <summary>
        ///     Gets the input registers.
        /// </summary>
        public ModbusDataCollection<short> InputRegisters { get; private set; }
